    ...
    <div class="testimony-container">
      ...
      <div class="testimony-grid">
        ...
        <div class="testimony-card">
          ...
          <p class="testimony-card-text">
            BCC 2024? My experience was raw power! raw prophecies! raw testimonies! All stirring me to more devotion to God's plan. Glory to God!!!
          </p>
        ...
        <div class="testimony-card">
          ...
          <p class="testimony-card-text">
            Believers Cave Conference has really impacted my life in great measures. The first time I attended was in 2020, and it was awesomely amazing. After that encounter, I have never missed the camp meeting since then.
          </p>
          <p class="testimony-card-text">
            It was in BCC that I learned how to study God's word and interpret the scriptures. It was in Believers Cave Conference that I began to experience the supernatural and the miraculous, and since then, I began to have a consistent prayer life. My expectations are high already, I can't wait to be in BCC'25
          </p>
        ...
        <div class="testimony-card">
          ...
          <p class="testimony-card-text">
            In 2022, during my compulsory service year, I had the privilege of attending BCC. At the time, I was awaiting admission and resumption into the Nigerian Law School. During one of the sessions, I received prophetic words concerning my law school journey; about the kind of people I would encounter and how the entire process would unfold. I wrote those words down and held on to them. Now, three years later, I'm a lawyer, and every single word has come to pass!
          </p>
          <p class="testimony-card-text">
...
<style>
@import '../assets/css/testimony-section/testimony.css';
</style>